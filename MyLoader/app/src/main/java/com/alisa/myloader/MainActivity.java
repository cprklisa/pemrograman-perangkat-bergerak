    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == CONTACT_LOAD) {
            ...
            if (PermissionManager.isGranted(this, Manifest.permission.CALL_PHONE)) {
                ...
                PermissionManager.check(this, Manifest.permission.CALL_PHONE,
                        CALL_REQUEST_CODE);
            }
        }
    }
        ...
        if (requestCode == CONTACT_REQUEST_CODE) {
            if (grantResults.length > 0) {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    getSupportLoaderManager().initLoader(CONTACT_LOAD,
                            null, this);
                    Toast.makeText(this, "Contact permission diterima",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, "Contact permission ditolak",
                            Toast.LENGTH_SHORT).show();
                }
            }
